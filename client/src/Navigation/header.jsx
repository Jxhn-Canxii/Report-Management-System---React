  ...
  return (
    ...
    <aside className="main-sidebar sidebar-dark-primary elevation-4">
      <Link className="brand-link">
          <img src={logo} alt="Company Logo" className="brand-image img-circle elevation-3" />
      ...
      <div className="sidebar">
          <div className="user-panel mt-3 pb-3 mb-3 d-flex">
              <div className="image">
                  <img src={profile} alt="User Profile" className="img-circle elevation-2" />
              </div>
              <div className="info">
                  <Link  className="d-block">Admin</Link>
              </div>
          </div>
        <nav className="mt-2" style={{height: '100vh'}}>
